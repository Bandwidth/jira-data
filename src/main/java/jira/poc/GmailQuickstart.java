...
public class GmailQuickstart {
    private static final String APPLICATION_NAME = "Gmail API Java Quickstart 1.00.01";
    ...
    public static void main(String... args) throws IOException, GeneralSecurityException, MessagingException {
        ...
        String bodyText = getEmailText();

        Address[] addresses = new Address[]{ new InternetAddress(to1), new InternetAddress(to2)};
...
//        Message message = createMessageWithEmail(mimeMessage);
    ...
    private static String getEmailText(){
        ...
        text += "<title>The HTML5 Herald</title>";
        text += "<meta name=\"description\" content=\"The HTML5 Herald\">";
        text += "<meta name=\"author\" content=\"SitePoint\">";
        text += "</head>";
        text += "<body>";
     ...
     * @param addresses email addresses of the receiver
